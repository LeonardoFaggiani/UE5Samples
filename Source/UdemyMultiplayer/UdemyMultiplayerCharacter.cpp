...
AUdemyMultiplayerCharacter::AUdemyMultiplayerCharacter()	
{
...
void AUdemyMultiplayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AUdemyMultiplayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
